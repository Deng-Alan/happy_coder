...
import { PERSONAL_DEFAULT_SERVER_URL, PERSONAL_DEFAULT_WEBAPP_URL } from './personalEdition'
...
class Configuration {
  ...
  constructor() {
    ...
    this.serverUrl = PERSONAL_DEFAULT_SERVER_URL
    this.webappUrl = PERSONAL_DEFAULT_WEBAPP_URL
