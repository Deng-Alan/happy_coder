...
export const en = {
    ...
    server: {
        ...
        advancedFeatureFooter: "This is an advanced feature. Only change the server if you know what you're doing. After changing the server, the app will reconnect using a new local identity if needed."
    },
    ...
    sessionInfo: {
        ...
        resumeSession: 'Restore Conversation',
        resumeSessionSubtitle: 'Restore this conversation on the same machine',
        resumeSessionSameMachineOnly: 'This conversation can only be restored on the same machine where it started.',
        resumeSessionMachineOffline: 'This machine is offline. Restore is only available while it is online.',
        resumeSessionNeedsHappyAgent: 'Restore is unavailable on this machine. Please make sure the local daemon is running and up to date.',
        resumeSessionMissingMachine: 'This conversation is missing machine metadata, so it cannot be restored.',
        resumeSessionMissingBackendId: 'This conversation does not have a restorable Claude or Codex identifier.',
        resumeSessionUnexpectedDirectoryPrompt: 'Restore cannot create directories. Start the conversation manually from its original path.',
    ...
    agentInput: {
        permissionMode: {
            ...
            plan: 'plan',
            dontAsk: "don't ask",
            bypassPermissions: 'full yolo',
            badgeAcceptAllEdits: 'accept all edits',
            badgeBypassAllPermissions: 'full yolo',
