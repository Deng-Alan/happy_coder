...
export const zhHans: TranslationStructure = {
    ...
    server: {
        ...
        advancedFeatureFooter: "这是一个高级功能。只有在您知道自己在做什么时才修改服务器。修改后，如有需要，应用会使用新的本地身份重新连接。"
    },
    ...
    sessionInfo: {
        ...
        resumeSession: '恢复对话',
        resumeSessionSubtitle: '在同一台机器上恢复这段对话',
        resumeSessionSameMachineOnly: '这段对话只能在它最初启动的那台机器上恢复。',
        resumeSessionMachineOffline: '这台机器当前离线，只有在线时才能恢复对话。',
        resumeSessionNeedsHappyAgent: '这台机器暂时无法恢复对话，请确认本地守护进程已启动且版本为最新。',
        resumeSessionMissingMachine: '这段对话缺少机器元数据，因此无法恢复。',
        resumeSessionMissingBackendId: '这段对话缺少可恢复的 Claude 或 Codex 标识。',
        resumeSessionUnexpectedDirectoryPrompt: '恢复对话时不能自动创建目录，请在原始路径手动启动。',
    ...
    agentInput: {
        permissionMode: {
            ...
            plan: '计划模式',
            dontAsk: '不再询问',
            bypassPermissions: '完全 YOLO',
            badgeAcceptAllEdits: '接受所有编辑',
            badgeBypassAllPermissions: '完全 YOLO',
            badgePlanMode: '计划模式',
        },
        agent: {
            claude: 'Claude',
