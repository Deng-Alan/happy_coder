...
export const zhHant: TranslationStructure = {
    ...
    server: {
        ...
        advancedFeatureFooter: "這是一個進階功能。只有在您知道自己在做什麼時才修改伺服器。修改後，如有需要，應用會使用新的本機身份重新連線。"
    },
    ...
    sessionInfo: {
        ...
        resumeSession: '恢復對話',
        resumeSessionSubtitle: '在同一台機器上恢復這段對話',
        resumeSessionSameMachineOnly: '這段對話只能在最初啟動它的那台機器上恢復。',
        resumeSessionMachineOffline: '這台機器目前離線，只有在線時才能恢復對話。',
        resumeSessionNeedsHappyAgent: '這台機器暫時無法恢復對話，請確認本機守護程序已啟動且版本為最新。',
        resumeSessionMissingMachine: '這段對話缺少機器中繼資料，因此無法恢復。',
        resumeSessionMissingBackendId: '這段對話缺少可恢復的 Claude 或 Codex 識別碼。',
        resumeSessionUnexpectedDirectoryPrompt: '恢復對話時不能自動建立目錄，請在原始路徑手動啟動。',
