        ...
        (async () => {
            ...
            try {
                ...
                if (credentials) {
                    ...
                    const personalCredentials = await createPersonalCredentials();
                    const saved = await TokenStorage.setCredentials(personalCredentials);
                    if (!saved) {
                        throw new Error('Failed to save personal credentials');
                    }
